...
const InfoUpload = ({ isfiles, StatusUpload, setInfo, Info, refetchCatalog }) => {
    return <>
        <BtnClose refetchCatalog={refetchCatalog} />
...
const AddBook = ({ addDocsToState, stateAddition, updatePost, result, refetchCatalog }) => {
    ...
    return (
        <>
            <section className={style.uploadBookPopUp}>
                ...
                <InfoUpload isfiles={isfiles} refetchCatalog={refetchCatalog} StatusUpload={StatusUpload} setInfo={setInfo} Info={Info} />
